 ...
 */
final class Version20210713082615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emprunt ADD emprunteur_id INT NOT NULL, ADD livre_id INT DEFAULT NULL');
